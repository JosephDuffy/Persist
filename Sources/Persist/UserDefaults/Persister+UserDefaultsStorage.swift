...
extension Persister where Value: StorableInUserDefaults {
    ...
    /**
     ...
     - parameter defaultValuePersistBehaviour: An option set that describes when to persist the default value.
     */
...
extension Persister {
    ...
    /**
     ...
     - parameter defaultValuePersistBehaviour: An option set that describes when to persist the default value.
     */
    internal convenience init<WrappedValue>(
        key: String,
        storedBy userDefaultsStorage: UserDefaultsStorage,
    ...
    /**
     ...
     - parameter defaultValuePersistBehaviour: An option set that describes when to persist the default value.
     */
    internal convenience init<Transformer: Persist.Transformer>(
        key: String,
        storedBy userDefaultsStorage: UserDefaultsStorage,
    ...
    /**
     ...
     - parameter defaultValuePersistBehaviour: An option set that describes when to persist the default value.
     */
    internal convenience init<Transformer: Persist.Transformer, WrappedValue>(
        key: String,
        storedBy userDefaultsStorage: UserDefaultsStorage,
        transformer: Transformer,
        defaultValue: WrappedValue,
