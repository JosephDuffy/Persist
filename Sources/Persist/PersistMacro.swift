...
//) = #externalMacro(module: "PersistMacros", type: "Persist_UserDefaults_NoTransformer")
//
//// MARK: - Throwing Input Transformer
//
//@attached(peer, names: suffixed(_storage), prefixed(`$`), suffixed(_cache))
//@attached(accessor)
...
//    key: String,
//    userDefaults: UserDefaults,
//    transformer: any ThrowingInputTransformer<Input, Output>,
//    cacheValue: Bool = false
//) = #externalMacro(module: "PersistMacros", type: "Persist_UserDefaults_ThrowingInputTransformer")
//
//@attached(peer, names: suffixed(_storage), prefixed(`$`), suffixed(_cache))
//@attached(accessor)
//public macro Persist<Input, Output>(
...
//) = #externalMacro(module: "PersistMacros", type: "Persist_UserDefaults_ThrowingInputTransformer")
//
//// MARK: - Throwing Output Transformer
//
//@attached(peer, names: suffixed(_storage), prefixed(`$`), suffixed(_cache))
//@attached(accessor)
//public macro Persist<Input, Output>(
//    key: String,
//    userDefaults: UserDefaults,
//    transformer: any ThrowingOutputTransformer<Input, Output>,
//    cacheValue: Bool = false
//) = #externalMacro(module: "PersistMacros", type: "Persist_UserDefaults_ThrowingOutputTransformer")
//
//@attached(peer, names: suffixed(_storage), prefixed(`$`), suffixed(_cache))
//@attached(accessor)
//public macro Persist<Input, Output>(
...
//    cacheValue: Bool = false
//) = #externalMacro(module: "PersistMacros", type: "Persist_UserDefaults_ThrowingTransformer")
//
//@attached(peer, names: suffixed(_storage), prefixed(`$`), suffixed(_cache))
//@attached(accessor)
//public macro Persist<Input, Output>(
...
//
//public struct UserDefaultsPersister<Input, Transformer> {
...
//    }
//
//    public func set(_ value: Input?, forKey key: String) {
//        userDefaults.set(value, forKey: key)
//    }
//
//    public func object(forKey key: String) -> Input? {
//        userDefaults.object(forKey: key) as? Input
//    }
//}
//
//extension UserDefaultsPersister where Transformer: Persist.Transformer, Input == Transformer.Input {
//    public func set(_ value: Input, forKey key: String) {
...
//}
//
//extension UserDefaultsPersister where Transformer: Persist.ThrowingInputTransformer, Input == Transformer.Input {
//    public func set(_ value: Input, forKey key: String) throws(Transformer.TransformInputError) {
...
//}
//
//extension UserDefaultsPersister where Transformer: Persist.ThrowingOutputTransformer, Input == Transformer.Input {
//    public func set(_ value: Input, forKey key: String) {
//        let transformed = transformer.transformInput(value)
//        userDefaults.set(transformed, forKey: key)
//    }
//
//    public func object(forKey key: String) throws(Transformer.TransformOutputError) -> Input? {
//        guard let transformed = userDefaults.object(forKey: key) as? Transformer.Output else {
//            return nil
//        }
...
//}
//
//extension UserDefaultsPersister where Transformer: Persist.ThrowingTransformer, Input == Transformer.Input {
//    public func set(_ value: Input, forKey key: String) throws(Transformer.TransformInputError) {
//        let transformed = try transformer.transformInput(value)
//        userDefaults.set(transformed, forKey: key)
//    }
